...
| Claude Code (CLI) | Opus 4.6/4.7 | 兼容 | 行为模式与 4.8 一致 |
| Claude Code (CLI) | Fable 5 | 完全适配 | 对结构化指令遵循度最高 |
| Claude Code (CLI) | Sonnet 4.x | 兼容 | 指令遵循度高 |
| Codex Desktop App | GPT 5.5 | **实测通过** | 同一 DNF 任务完整交付 |
| Codex (CLI) | GPT 5.3/5.4 | 兼容 | 同一 system-prompt.md 生效 |
